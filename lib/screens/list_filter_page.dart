...
class ListFilterPage extends StatelessWidget {
  final List<dynamic> items;
  final int type;
  const ListFilterPage({super.key, required this.items, required this.type});
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              type == 0 ? l10n.allTutors : l10n.allCourses,
            ...
            Expanded(
              child: items.isEmpty
                  ? Center(
                      child: Text(
                        type == 0 ? l10n.noTutorsFound : l10n.noCoursesFound,
                        style: TextStyle(fontSize: 16, color: Colors.black),
                      ),
                    )
                  : (type == 0
                        ? _buildTutors(context)
  ...
  Widget _buildTutors(BuildContext context) {
    final l10n = context.l10n;
            ...
            child: Row(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text(
                      l10n.pricePerHour(data.price.toStringAsFixed(0)),
                      style: TextStyle(
                        fontSize: 16,
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        return InkWell(
          ...
          child: buildCardCourse(context, data),
        );
      },
    );
  }
